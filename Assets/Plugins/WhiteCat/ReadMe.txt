White Cat's Toolbox
	...
	Asset Store:
		https://www.assetstore.unity3d.com/#!/content/32356?aid=1101lGxh

	Documentation:
		https://github.com/silentlamb1991/WhiteCatToolbox/wiki

	Support E-mail:
		whitecat1991@outlook.com
...
Detail:
	Add editor scope types.
	Add BlendEffectController.
	Add ScriptableComponentWithUpdateMode.
	Add WaitForFixedUpdate, WaitForEndOfFrame for UpdateMode.
	Now allow to get and modify interpolator of Tweener via scripts.
